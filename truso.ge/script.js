const images = [
 ...
 function showPage(pageId) {
  ...
  const sectionsGuide = document.querySelectorAll('.guide');
  // Hide all sections
  ...
  sectionsGuide.forEach(sectionsGuide=> {
    sectionsGuide.style.display = 'none';
});
  ...
  const activeSectionGuiding = document.getElementById(pageId);
  if (activeSectionGuiding) {
    activeSectionGuiding.style.display = 'block';
  }
}
